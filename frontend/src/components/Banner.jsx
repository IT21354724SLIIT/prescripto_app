...
const Banner = () => {
  ...
  return (
    <div className="flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10 relative">
      {/*-----------Left Side------------*/}
      ...
      <div className="hidden md:block md:w-1/2 lg:w-[330px] relative">
        <img
          className="w-full absolute bottom-0 right-[-140px] max-w-xs lg:max-w-md"
